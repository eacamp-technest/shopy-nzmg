...
import { authStackScreenOption, defaultScreenOptions } from 'configs/navigation.configs'
    ...
    return (
        ...
        >
            <AuthStack.Navigator
                ...
                <AuthStack.Screen name={Routes.welcome} component={WelcomeScreen} options={defaultScreenOptions} />
