...
const colorArr = [colors.sky.lighter, colors.sky.base, colors.red.darkest, colors.mellowApricot.base, colors.bdazzleBlue.base, colors.sky.dark]
...
export const FilterScreen = () => {
    ...
    const handlePriceChange = (priceRange: { min: number; max: number }) => {
        console.log(`Price range changed: ${priceRange.min.toFixed(2)} - ${priceRange.max.toFixed(2)}`);
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.priceRange} >
                <Text style={styles.priceRangeText}>${selectedMinPrice.toFixed(2)}</Text>
                <Text style={styles.priceRangeText}>${selectedMaxPrice.toFixed(2)}</Text>
            </View>
            <PriceBar
                minPrice={0}
                maxPrice={200}
            ...
            <FlatList
                ...
                data={categories}
                renderItem={({ item }) => (<Category item={item} backgroundColor={colors.blue.base} selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory} />)} horizontal={true} keyExtractor={(item) => item} />
