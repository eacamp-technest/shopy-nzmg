import { View, Text, Pressable, StyleSheet, Image, ImageSourcePropType, StyleProp, ViewStyle, Modal as NativeModal } from "react-native";
import React, { ForwardRefRenderFunction, forwardRef, isValidElement, useCallback, useImperativeHandle, useState } from "react";
import { colors } from "theme/colors";
import { windowWidth } from "theme/consts.styles";
import { Buttons, IButton } from "./Buttons";
...
const Modal: ForwardRefRenderFunction<IModalRefCallbacks, IModal> = (
    ...
    const renderButtons = useCallback(
        (buttonContext: IModalButtons, index: number) => {
            return <Buttons key={index} {...buttonContext} />;
        },
        [],
    );
